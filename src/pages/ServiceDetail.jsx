...
function ServiceDetail() {
    ...
    const loadServiceDetails = async () => {
        ...
        try {
            ...
            if (serviceResult.success) {
                ...
                console.log('✅ Serviço carregado:', serviceResult.data);
            } else {
            ...
            try {
                ...
                if (reviewsResult.success && reviewsResult.data) {
                    ...
                    console.log('✅ Avaliações carregadas:', reviewsResult.data);
                }
            } catch (error) {
            ...
            try {
                ...
                if (ratingResult.success && ratingResult.data) {
                    ...
                    console.log('✅ Rating carregado:', ratingResult.data);
                }
            } catch (error) {
                console.log('ℹ️ Nenhuma avaliação encontrada');
    ...
    const handleBooking = async (e) => {
        ...
        console.log('Dados originais:', bookingData);
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                            ...
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <span className={`px-3 py-1 rounded-full text-sm ${service?.serviceStatus === 'Ativo'
                                    ? 'bg-green-100 text-green-800'
                                    : 'bg-gray-100 text-gray-800'
                                    }`}>
                                    {service?.serviceStatus || 'Ativo'}
                                </span>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <p className="text-gray-600 leading-relaxed">
                                    {service?.details || 'Sem descrição disponível.'}
                                </p>
                            </div>
                                ...
                                {assessments.length === 0 ? (
                                    <div className="text-center py-8 bg-gray-50 rounded-lg">
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">
                                            Seja o primeiro a contratar e avaliar!
                                        </p>
                                    </div>
                                ) : (
                                                    ...
                                                    <div className="flex-1">
                                                        <div className="flex items-center gap-2 mb-1">
                                                            <span className="font-medium text-gray-800">
                                                                {review.clientName || review.client?.userName || 'Cliente'}
                                                            </span>
                                                            <div className="flex">
                                                                {[...Array(5)].map((_, i) => (
                                                                    <Star
                                                                        key={i}
                                                                        className={`w-4 h-4 ${i < (review.rating || review.score)
                                                        ...
                                                        <p className="text-gray-700 text-sm">
                                                            {review.comment || review.comments || 'Sem comentário'}
                                                        </p>
                                                        {review.createdAt && (
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
                                ...
                                {service?.professional ? (
                                    <div className="flex items-center gap-3">
                                        {service.professional.profilePhoto ? (
                                            <img
                                                src={service.professional.profilePhoto}
                                                alt={service.professional.userName}
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">
                                                {service.professional.profession || 'Profissional'}
                                            </p>
                                            {service.professional.userType === 'Profissional' && (
                            ...
                            <button
                                ...
                                disabled={!service}
                                className="w-full bg-yellow-400 hover:bg-yellow-500 text-white py-3 rounded-lg font-semibold transition disabled:bg-gray-300 disabled:cursor-not-allowed"
                            >
                                Agendar Serviço
                            </button>
                        </div>
            ...
            {showBookingModal && (
                ...
                >
                    <div
                        className="bg-white rounded-lg p-6 max-w-md w-full shadow-2xl relative border border-gray-200"
                    ...
                    >
                        ...
                        <form onSubmit={handleBooking} className="space-y-4">
                            ...
                            <div className="flex gap-3 mt-6">
                                ...
                                <button
                                    type="submit"
                                    className="flex-1 px-4 py-2 bg-yellow-400 text-gray-900 rounded-lg hover:bg-yellow-500 transition font-semibold"
                                >
