    ...
    const filterServices = () => {
        ...
        if (selectedCategory !== 'Todos') {
            filtered = filtered.filter(
                (service) => service.category?.categoryName === selectedCategory
            );
        }
                ...
                <div className="flex gap-2 overflow-x-auto pb-2">
                    {categories.map((category) => (
                        <button
                            ...
                            className={`px-6 py-2 rounded-full whitespace-nowrap transition ${selectedCategory === category
                            ...
                            >
                                <div className="p-6">
                                    <div className="flex justify-between items-start mb-3">
                                        ...
                                        <span
                                            className={`px-3 py-1 rounded-full text-sm ${service.serviceStatus === 'Ativo'
                                    ...
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <span className="text-sm text-gray-600">
                                            {service.professional?.userName || 'Profissional'}
                                        </span>
                                    </div>
                                    ...
                                    {service.category && (
                                        <div className="mt-4 pt-4 border-t">
                                            <span className="inline-block px-3 py-1 bg-violet-100 text-violet-800 rounded-full text-sm">
