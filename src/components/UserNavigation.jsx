            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        <Link
                            to="/perfil"
                            className="flex items-center space-x-2 text-gray-700 hover:text-violet-400 transition-colors"
                        >
                            <div className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center">
                                {userData?.profilePhoto ? (
                                    ...
                                    <div className="w-full h-full bg-violet-400 flex items-center justify-center text-white font-bold">
                                        {getUserInitials()}
                                    </div>
                                )}
                            </div>
                        ...
                        <button
                            ...
                            className="flex items-center space-x-2 bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded-lg transition-colors font-medium"
                        >
                            <LogOut size={18} />
                            <span>Sair</span>
                        </button>
                    ...
                    <button
                        ...
                        className="md:hidden text-gray-700 hover:text-violet-400"
                    >
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden py-4 border-t border-gray-200">
                        <div className="flex flex-col space-y-4">
                            ...
                            <button
                                onClick={handleLogout}
                                className="flex items-center justify-center space-x-2 mx-4 bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded-lg transition-colors font-medium"
                            >
                                <LogOut size={18} />
                                <span>Sair</span>
                            </button>
